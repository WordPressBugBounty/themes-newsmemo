...
?>
<header id="dt_header" class="dt_header header--twelve menu_active-three">
		...
		<div class="dt_header-navwrapper">
			<div class="dt_header-navwrapperinner">
				...
				<div class="dt_navbar dt-d-none dt-d-lg-block">
					<div class="dt_navbar-wrapper <?php if($newsmunch_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','newsmemo'); endif; ?>">
						<div class="dt_navbar-inner <?php if ( has_header_image() ) : esc_attr_e('data-bg-image','newsmemo'); endif;?>" <?php if ( has_header_image() ) : ?> data-bg-image="<?php echo esc_url( get_header_image()); ?>"<?php endif; ?>>
				...
				<div class="dt_mobilenav dt-d-lg-none">
					...
					<?php } ?>
					<div class="dt_mobilenav-main <?php if ( has_header_image() ) : esc_attr_e('data-bg-image','newsmemo'); endif;?> <?php if($newsmunch_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','newsmemo'); endif; ?>" <?php if ( has_header_image() ) : ?> data-bg-image="<?php echo esc_url( get_header_image()); ?>"<?php endif; ?>>
						<div class="dt-container-md">
							<div class="dt-row">
								<div class="dt-col-12">
